  ...
  <body>
    <main>
      <header class="navbar">
        ...
        <h1 class="navbar-services"><a href="{{ route('user projects', Auth::id()) }}">Projects</a></h1>
        <h1 class="navbar-about"><a href="{{ route('invites', Auth::id()) }}">Invites</a></h1>  
        <h1 class="navbar-about"><a href="{{ route('notes', Auth::id()) }}">Notifications</a></h1> 
      </header>
      <section id="content">
          @yield('content')
      </section>
